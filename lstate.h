...
typedef struct global_State {
  ...
  TString* tmname _Checked[24];  /* array with tag-method names */
  struct Table* mt _Checked[9];  /* metatables for basic types */
  TString* strcache _Checked[53][2];  /* cache for strings in API */
} global_State;
